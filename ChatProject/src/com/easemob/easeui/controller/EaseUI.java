...
public final class EaseUI {
     ...
     * @return
     */
    public synchronized boolean init(Context context,int sslRawId){
        if(sdkInited){
            return true;
        }
        appContext = context;
        ...
        requestQueue = Volley.newRequestQueue(appContext,new HurlStack(null, buildSSLSocketFactory(context,sslRawId)));
...
//        notifier.setNotificationInfoProvider(getNotificationListener());
    ...
    public  interface EaseUserProfileProvider {
         ...
         * @return
         */
        EaseYAMUser getUser(String username);
    }
