...
public class TouchImageView extends VolleyImageView {
	...
	public TouchImageView(final Context context, AttributeSet attrs, int defStyle) {
...
//                }
			...
			public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
				...
				mFlingScroller.fling(
						Math.round(mTranslationX), Math.round(mTranslationY), Math.round(velocityX), Math
						.round(velocityY), Math.round(minTranslationX), Math.round(maxTranslationX), Math
						.round(minTranslationY), Math.round(maxTranslationY));
