...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabPaddingLeft = 20;
    private int tabPaddingRight = 20;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_pstsIndicatorColor, indicatorColor);
        underlineColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsDividerColor, dividerColor);
        indicatorHeight = a
                .getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight,
                        indicatorHeight);
        underlineHeight = a
                .getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight,
                        underlineHeight);
        dividerPadding = a
                .getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsDividerPadding,
                        dividerPadding);
//        tabPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, tabPadding);
        ...
        if (isShowDivider) {
            expandedTabLayoutParams.setMargins((int) TypedValue
    ...
    public void settTabPaddingLeft(int tabPaddingLeft)
    {
...
//            }
    ...
    public void updateTabVaue(String[] values){

        Log.d("tabsCount", "--->" + tabCount + " size:" + values.length);
        if((values!=null&&values.length>0)|| values.length!=tabCount)
            return;

        for (int i = 0; i < tabCount; i++) {
                View v = tabsContainer.getChildAt(i);
                if (v instanceof TextView) {
                    Log.d("tabsCount","--->"+tabCount  +" value:"+values[i]);
                    TextView tab = (TextView) v;
                    if(values[i]!=null){
                        tab.setText(values[i]);
                    }
                }
        }
        invalidate();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft-(int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2,
                        EaseUI.displayMetrics), height - indicatorHeight, lineRight+(int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2,
                        EaseUI.displayMetrics), height, rectPaint);
