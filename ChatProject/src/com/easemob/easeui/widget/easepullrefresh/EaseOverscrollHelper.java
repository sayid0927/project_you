...
@TargetApi(9)
public final class EaseOverscrollHelper {

	static final String LOG_TAG = "EaseOverscrollHelper";
	 ...
	 */
	public static void overScrollBy(final EasePullToRefreshBase<?> view, final int deltaX, final int scrollX,
	...
	public static void overScrollBy(final EasePullToRefreshBase<?> view, final int deltaX, final int scrollX,
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (EasePullToRefreshBase.DEBUG) {
