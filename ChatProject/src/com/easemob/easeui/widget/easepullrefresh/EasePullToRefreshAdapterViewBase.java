...
public abstract class EasePullToRefreshAdapterViewBase<T extends AbsListView> extends EasePullToRefreshBase<T> implements
    OnScrollListener
{
    ...
    private EaseIndicatorLayout mIndicatorIvTop;
    
    private EaseIndicatorLayout mIndicatorIvBottom;
    
    private boolean mShowIndicator;
    
    private boolean mScrollEmptyView = true;
    
    public EasePullToRefreshAdapterViewBase(Context context)
    {
        super(context);
        mRefreshableView.setOnScrollListener(this);
    }
    
    public EasePullToRefreshAdapterViewBase(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        mRefreshableView.setOnScrollListener(this);
    }
    
    public EasePullToRefreshAdapterViewBase(Context context, Mode mode)
    {
        super(context, mode);
        mRefreshableView.setOnScrollListener(this);
    }
    
    public EasePullToRefreshAdapterViewBase(Context context, Mode mode, AnimationStyle animStyle)
    {
     ...
     * {@link EasePullToRefreshBase#isPullToRefreshOverScrollEnabled()
    ...
    /**
     * Pass-through method for {@link EasePullToRefreshBase#getRefreshableView()
     * getRefreshableView()}.
    ...
    public final void setEmptyView(View newEmptyView)
    {
        ...
        if (mRefreshableView instanceof EaseEmptyViewMethodAccessor)
        {
            ((EaseEmptyViewMethodAccessor)mRefreshableView).setEmptyViewInternal(newEmptyView);
        }
        else
        {
    ...
    protected void handleStyledAttributes(TypedArray a)
    {
        ...
        mShowIndicator = a.getBoolean(R.styleable.EasePullToRefresh_easeptrShowIndicator, !isPullToRefreshOverScrollEnabled());
    }
    ...
    private void addIndicatorViews()
    {
        ...
        if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop)
        {
            ...
            mIndicatorIvTop = new EaseIndicatorLayout(getContext(), Mode.PULL_FROM_START);
            FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            params.rightMargin = getResources().getDimensionPixelSize(R.dimen.sidebar_text_size);
        ...
        {
            // If the mode can pull down, and we don't have one set already
            mIndicatorIvBottom = new EaseIndicatorLayout(getContext(), Mode.PULL_FROM_END);
            FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            params.rightMargin = getResources().getDimensionPixelSize(R.dimen.sidebar_text_size);
