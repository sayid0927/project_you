...
public class EaseSoundPullEventListener<V extends View> implements EasePullToRefreshBase.OnPullEventListener<V> {

	private final Context mContext;
	private final HashMap<EasePullToRefreshBase.State, Integer> mSoundMap;
	 ...
	 */
	public EaseSoundPullEventListener(Context context) {
		mContext = context;
		mSoundMap = new HashMap<State, Integer>();
	}

	@Override
	public final void onPullEvent(EasePullToRefreshBase<V> refreshView, State event, Mode direction) {
