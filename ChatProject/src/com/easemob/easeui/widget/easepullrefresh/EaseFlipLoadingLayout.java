...
public class EaseFlipLoadingLayout extends EaseLoadingLayout {

	static final int FLIP_ANIMATION_DURATION = 150;

	private final Animation mRotateAnimation, mResetRotateAnimation;

	public EaseFlipLoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
	...
	protected int getDefaultDrawableResId() {
		return R.drawable.ease_default_ptr_flip;
	}
