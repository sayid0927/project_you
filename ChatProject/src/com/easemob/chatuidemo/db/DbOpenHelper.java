...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String USERNAME_TABLE_CREATE = "CREATE TABLE "
            ...
            + UserDao.COLUMN_NAME_REMARKNAME + " TEXT, "
            + UserDao.COLUMN_NAME_ISBLACK + " INTEGER, "
            + UserDao.COLUMN_NAME_SHOPID + " INTEGER, "
            + UserDao.COLUMN_NAME_GROUPID + " INTEGER, "
            + UserDao.COLUMN_NAME_ADDEDTIME + " LONG, "
            + UserDao.COLUMN_NAME_CREATETIME + " LONG, "
            + UserDao.COLUMN_NAME_USERID + " LONG, "
            + UserDao.COLUMN_NAME_GENDER + " INTEGER, "
            + UserDao.COLUMN_NAME_ORIGINHEADURL + " TEXT, "
            + UserDao.COLUMN_NAME_GROUPNAME + " TEXT, "
            + UserDao.COLUMN_NAME_ID + " TEXT, "
            + UserDao.COLUMN_NAME_SIGNATURE + " TEXT, "
            + UserDao.COLUMN_NAME_INITIAL + " TEXT, "
            + UserDao.COLUMN_NAME_ISTOP + " INTEGER, "
            + UserDao.COLUMN_HX_ID + " TEXT PRIMARY KEY);";
    ...
    private static final String CREATE_UNREGIST_TABLE = "CREATE TABLE "
            + UserDao.UNREGIST_TABLE_NAME + " ("
            + UserDao.UNREGIST_IMEI + " TEXT);";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_UNREGIST_TABLE);
