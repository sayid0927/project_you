...
public class PayAddBankcardInfoAct extends BasicAct implements View.OnClickListener {
    ...
    private void getTakeoutVerifyPayNo(String orderNo) {
        payGetPayNoRequest = new PayGetPayNoRequest(orderNo, payType, Constants.BUSINESS_OTHER_TYPE, Constants.CHANNEL_TAKEOUT_VERIFY, Constants.PAY_DEVICE_TYPE, Account.user.getShopId());
