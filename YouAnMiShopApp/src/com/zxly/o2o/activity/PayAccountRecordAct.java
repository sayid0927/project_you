...
public class PayAccountRecordAct extends BasicAct implements View.OnClickListener, ParameCallBack {
    ...
    /**
     * @param initTab 初始tab页面     0:"全部" 1:"商品" 2:"流量" 3:"延保" 4:"应用" 5:"提现"
     */
    ...
    private void initViews() {
        ...
        fragments.add(new AccountRecordFragment());
        fragments.add(new AccountRecordFragment());
        String strings[] = {"全部", "商品", "流量", "延保", "应用", "提现"};
        ...
        tabs.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                switch (i) {
                    ...
                    case 1:
                        ((AccountRecordFragment) fragments.get(i))
                                .init(AccountRecordFragment.ACCOUNT_RECORD_PRODUCT);
                        break;
                    case 2:
                        ((AccountRecordFragment) fragments.get(i))
                    ...
                    case 4:
                        ((AccountRecordFragment) fragments.get(i))
                                .init(AccountRecordFragment.ACCOUNT_RECORD_APPLICATION);
                        break;
                    case 5:
                        ((AccountRecordFragment) fragments.get(i))
