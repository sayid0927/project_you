...
import com.zxly.o2o.adapter.SelectedPicGVAdapter;
...
public class AlbumActivity extends BasicAct {
    ...
    private SelectedPicGVAdapter gridImageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaxSelectedSize = getIntent().getIntExtra("MaxSelectedSize",9);
        setUpActionBar("全部照片");
        init();
        initListener();
    ...
    private void init() {
        ...
        gridImageAdapter = new SelectedPicGVAdapter(this, dataList, selectedDataList = selectedDataList == null ? new ArrayList<String>() : selectedDataList);
    ...
    private void initListener() {
        ...
        gridImageAdapter.setOnItemClickListener(new SelectedPicGVAdapter.OnItemClickListener() {
    ...
    public static void fragmentStrt(UserDefinedSendFragment activity, Intent intent, ParameCallBackById _callBack){
        callBack = _callBack;
        activity.startActivityForResult(intent, Constants.GET_PIC_FROM_CAMERA);
        activity.getActivity().overridePendingTransition(R.anim.slide_left_in, R.anim.slide_left_out);
    }
