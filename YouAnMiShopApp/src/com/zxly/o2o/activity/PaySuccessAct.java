...
public class PaySuccessAct extends BasicAct implements View.OnClickListener {
     ...
     */
    public static void start(Activity curAct, float orderMoney, String orderNo, int type, String description) {
     ...
     */
    public static void start(Activity curAct, float orderMoney, String orderNo, int type, String description, UserBankCard userBankCard, float moneyInput, String userPaw) {
        Intent intent = new Intent(curAct, PaySuccessAct.class);
        intent.putExtra("orderMoney", orderMoney);
        intent.putExtra("orderNo", orderNo);
        intent.putExtra("type", type);
