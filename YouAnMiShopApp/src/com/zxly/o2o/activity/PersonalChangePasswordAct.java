...
import com.zxly.o2o.request.ChangeLoginPwdRequest;
...
public class PersonalChangePasswordAct extends BasicAct implements
    ...
    private void initViews() {
        ...
        if ("login".equals(type)) {
            ...
            if (Account.user != null && Account.user.getMobilePhone()!= null) {
...
//					int msgCode = Integer.parseInt(editVerifyCode.getText().toString().trim());
    ...
    private void changeLoginPwd(final String confirmPassword) {
        final ChangeLoginPwdRequest request = new ChangeLoginPwdRequest(
