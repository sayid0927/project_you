...
public class MRatingBar extends LinearLayout{
    ...
    public MRatingBar(Context context, AttributeSet attrs) {
        ...
        countNum = typedArray.getInt(R.styleable.MRatingBar_starCount, 5);
        countSelected = typedArray.getInt(R.styleable.MRatingBar_countSelected, 0);
        canEdit = typedArray.getBoolean(R.styleable.MRatingBar_canEdit, false);
        differentSize = typedArray.getBoolean(R.styleable.MRatingBar_differentSize, false);
        widthAndHeight = typedArray.getDimension(
                R.styleable.MRatingBar_widthAndHeight,0);
        dividerWidth = typedArray.getDimension(
                R.styleable.MRatingBar_dividerWidth,0);
        stateResId = typedArray.getResourceId(
                R.styleable.MRatingBar_stateResId, -1);
        initView();
    }
