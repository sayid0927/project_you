 ...
 */
public abstract class WheelTextAdapter extends WheelAdapter {
	 ...
	 */
	protected WheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
...
//		view.setTypeface(Typeface.SANS_SERIF, Typeface.BOLD);
	...
	private TextView getTextView(View view, int textResource) {
		...
		try {
			...
			Log.e("WheelAdapter", "You must supply a resource ID for a TextView");
			throw new IllegalStateException("WheelAdapter requires the resource ID to be a TextView", e);
		}
