...
/**
 * Created by hejun on 2016/10/29.
 */
public class MenberGroupTagAdapter extends BaseAdapter implements FlowTagLayout.OnInitSelectedPosition {

    private final Context mContext;
    private final List<TagModel> mDataList;

    public MenberGroupTagAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_bigtag, null);
