 ...
 */
public class CommissionProductSetAdapter extends ObjectAdapter {
    ...
    public int getLayoutId() {
        return R.layout.item_commission_product1;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            holder.btnScale= (TextView) convertView.findViewById(R.id.btn_scale);
