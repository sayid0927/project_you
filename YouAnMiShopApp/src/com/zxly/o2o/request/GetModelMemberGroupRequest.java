 ...
 * @des: 机型会员组的请求 原来的 MenberGroupModel 换成 ModelMemberGroupModel
 */

public class GetModelMemberGroupRequest extends BaseRequest{
    ...
    public GetModelMemberGroupRequest(boolean b){
        this.b=b;
    ...
    protected void fire(String data) throws AppException {
        ...
        try {
            ...
            String json = jo.getString("dynamicGroup");
            ...
            for (int i = 0; i < length; i++) {
                ...
                menberGroupModel.setMemberCount(jsonObject.optInt("groupCount"));
                ...
                menberGroupModel.setName(jsonObject.optString("groupName"));
