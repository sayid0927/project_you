...
public class PayOrder implements Serializable {
    ...
    public  static final String BUSI_PARTNER_MATERIAL="109001";//实物商品销售
    public static final String  BUSI_PARTNER_VIRTUAL="101001";//虚拟商品销售
    ...
    private String flag_modify;//0 可以修改，1 不允许修改
