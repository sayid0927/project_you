...
public class SecondHandSelectedPicGVAdapter extends BaseAdapter implements OnClickListener {
    ...
    public SecondHandSelectedPicGVAdapter(Context c, ArrayList<String> dataList, ArrayList<String> selectedDataList) {
