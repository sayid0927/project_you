 ...
 */
public class CommissionListAdapter extends ObjectAdapter {
    ...
    private void fillData(ViewHolder holder,CommissionRecord commissionRecord){
        ...
        holder.txtOrderNo.setText("流水号 : "+commissionRecord.getOrderNo());
    //    holder.txtCommissionArriveDate.setText("预计到账时间 : "+ commissionRecord.getTimeStr());
