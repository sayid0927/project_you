...
//        tabPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, tabPadding);
        ...
        botLine = new Paint();
        botLine.setAntiAlias(true);
        botLine.setStrokeWidth(dividerWidth);

        botLine.setColor(getResources().getColor(R.color.gray_dcdcdc));
        ...
        if(isShowDivider) {
            expandedTabLayoutParams.setMargins((int) TypedValue
                    .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, AppController.displayMetrics), 0, (int) TypedValue
                    .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, AppController.displayMetrics), 0);
            expandedTabLayoutParams.setMargins(0,0,0, DesityUtil.dp2px(getContext(),3));
        }
        if (locale == null) {
...
//        canvas.drawRect(0, height - underlineHeight, tabsContainer.getWidth(), height, rectPaint);
      ...
      //  canvas.drawRect(getLeft(),height - indicatorHeight/2, getRight(), height, botLine);

        canvas.drawRect(lineLeft - (int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, AppController.displayMetrics), height - indicatorHeight, lineRight + (int) TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, AppController.displayMetrics), height, rectPaint);
