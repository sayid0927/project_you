...
public class TileBitmapDrawable extends Drawable {
    ...
    public void attachTileBitmapDrawable(ImageView imageView, InputStream is, Drawable placeHolder, OnInitializeListener listener) {
    ...
    private TileBitmapDrawable(ImageView parentView, BitmapRegionDecoder decoder, Bitmap screenNail) {
        ...
        mTileSize = com.zxly.o2o.config.Config.displayMetrics.densityDpi >= DisplayMetrics.DENSITY_HIGH ? TILE_SIZE_DENSITY_HIGH : TILE_SIZE_DEFAULT;
    ...
    private static final class getImageStreamTask extends AsyncTask<String, Void, TileBitmapDrawable> {
        ...
        protected TileBitmapDrawable doInBackground(String... params) {
            ...
            AppController.imageLoader.get(params[0], ImageLoader.getImageListener(mImageView, R.drawable.icon_default, R.drawable.icon_default));
        ...
        private TileBitmapDrawable DidDo(InputStream inputStream, String path) {
            ...
            final float minScale = Math.min(com.zxly.o2o.config.Config.displayMetrics.widthPixels / (float) decoder.getWidth(), com.zxly.o2o.config.Config.displayMetrics.heightPixels / (float) decoder.getHeight());
            ...
            Bitmap mbitmap;
            try {
                mbitmap = Bitmap.createScaledBitmap(decoder.decodeRegion(screenNailRect, options), Math.round(decoder.getWidth() * minScale), Math.round(decoder.getHeight() * minScale), true);
