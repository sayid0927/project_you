...
public class CircleProgress extends View {
	...
	private static final float DEFAULT_PAINT_WIDTH = 8; // 默认画笔宽度
	private static final int DEFAULT_PAINT_COLOR = 0xffdfdfdf; // 默认画笔颜色
	private static final boolean DEFAULT_FILL_MODE = true; // 默认填充模式
	private static final float DEFAULT_INSIDE_VALUE = 0; // 默认缩进距离
	...
	private int BackgroudColor = DEFAULT_PAINT_COLOR;
	...
	public CircleProgress(Context context, AttributeSet attrs) {
		...
		float paintWidth = array.getDimension(R.styleable.CircleProgressBar_Paint_Width, DEFAULT_PAINT_WIDTH); // 获取画笔宽度
		mCircleAttribute.setFill(bFill);
		if (bFill == false) {
			mCircleAttribute.setPaintWidth(paintWidth);
		}
		BackgroudColor = array.getColor(R.styleable.CircleProgressBar_Backgroud_Color, DEFAULT_PAINT_COLOR); // 获取画笔颜色
		int paintColor = array.getColor(R.styleable.CircleProgressBar_Paint_Color, DEFAULT_PAINT_COLOR); // 获取画笔颜色

		AppLog.i("paintColor = " + Integer.toHexString(paintColor));
		mCircleAttribute.setPaintColor(paintColor);

		mCircleAttribute.mSidePaintInterval = array.getDimension(R.styleable.CircleProgressBar_Inside_Interval,
	...
	class CircleAttribute {
		...
		public float mSidePaintInterval; // 圆形向里缩进的距离
		...
		public CircleAttribute() {
			...
			mBottomPaint.setColor(BackgroudColor);
