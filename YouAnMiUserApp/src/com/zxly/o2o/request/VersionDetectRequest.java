 ...
 */
public class VersionDetectRequest extends BaseRequest {
    ...
    public VersionDetectRequest(ParameCallBack callBack) {
            ...
            if (versionCodeMin > AppController.mVersionCode) {
                ...
                */
                if(jo.has("appStyleColorTemplate")){
                    ...
                    if(newH5VersionCode>defaultH5VersionNo||defaultStyleId!=newStyleId){
