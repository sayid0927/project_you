 ...
 */
public class ActivityProductListFilterRequest extends BaseRequest {

	private List<NewProduct> productList = new ArrayList<NewProduct>();

	public ActivityProductListFilterRequest(Paging paging, List<Filters> filterList) {
	...
	protected void fire(String data) throws AppException {
		...
		List<NewProduct> pList = GsonParser.getInstance().fromJson(data, type1);
