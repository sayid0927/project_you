...
public class PayConfirmDialog {
    ...
    private CallBack callBack2;//银行卡页面回调
            ...
            public void onCall(Object object) {
                ...
                if (Constants.RET_CODE_SUCCESS.equals(retCode)) {
                    ...
                    if (com.zxly.o2o.util.Constants.TYPE_FLOW_PAY == type) {
                        ...
                        PaySuccessAct.start(curAct, orderMoney, orderNo, type, PayAct.insuranceOrderId, description, userBankCard, moneyInput, userPaw);
                    }
