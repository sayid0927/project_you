...
import com.shyz.downloadutil.AppUtil;
...
import com.zxly.o2o.o2o_user.wxapi.Util;
import com.zxly.o2o.o2o_user.wxapi.WXEntryActivity;
...
public class ShareDialog extends BaseDialog implements View.OnClickListener{
    ...
    private String url ,title,imgName="test.png";
    ...
    public void show(String title,String desc,String targetUrl,Object image,String imgName,ShareListener shareListener) {
        super.show();
        this.title=title;
        this.desc=desc;
        this.url=targetUrl;
                ...
                switch (shareType){
                    ...
                    case SHARE_TO_QQ_ZOOM:
                        ...
                        if(imgInfo instanceof Bitmap){
                            ...
                            File shareImg =new BitmapUtil().saveBitmapToFile((Bitmap) imgInfo,imgName);
                            if(shareImg==null){
                                return;
                            }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    {
                         imgInfo = BitmapUtil.drawableToBitmap(context.getResources().getDrawable(R.drawable.icon_youanmi));
                    }
                    switch (position){
                        case 2:
